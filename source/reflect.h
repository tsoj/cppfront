...
#line 1207 "reflect.h2"
    {
        ...
        auto fallback_return {"        cpp2::type_safety.report_violation( (\"can't convert string '\" + cpp2::to_string(s) + \"' to " + cpp2::to_string(prefix) + "enum of type " + cpp2::to_string(CPP2_UFCS(name)(t)) + "\").c_str() );\n"
...
#line 1234 "reflect.h2"
        if (bitwise) {
            from_string += "            else { ";
            from_string += cpp2::move(fallback_return);
            from_string += " }\n"
                           "        }\n"
                           "        return ret;";
        }
